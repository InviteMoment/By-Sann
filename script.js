...
async function openInvitation() {
    ...
    /*
       Jangan letak setTimeout di sini.
       Browser perlukan user gesture
       untuk membenarkan audio.
    */
...
function renderMomentCarousel(
    ...
    chunks.forEach(
        (chunk, pageIndex) => {
            ...
            /*
               Kosongkan slot supaya
               setiap slide tetap 4 slot.
            */
