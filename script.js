...
function setMusicSource() {
    ...
    /*
       Pastikan URL muzik dibina berdasarkan
       lokasi sebenar index.html.
    */
...
async function playMusic() {
    ...
    try {
        ...
        /*
           Sentiasa set source sebelum play.
        */
...
/*
   Jika fail song.m4a tidak wujud,
   browser akan keluarkan error di console.
*/
...
async function openInvitation() {
    ...
    /*
       PENTING:
       Cover ditutup dahulu.
       Jangan tunggu music.play()
       sebelum menutup cover.
    */
    ...
    /*
       Cuba mainkan muzik terus daripada
       klik pengguna.

       Kalau browser block autoplay,
       website tetap boleh digunakan.
    */
...
function openGallery() {
    ...
    /*
       PENTING:
       Sheet upload TIDAK lagi memaparkan
       gallery/momen di bawah.
    ...
    */
    ...
    chunks.forEach(
        (chunk, pageIndex) => {
            ...
            /*
               Jika kurang daripada 4,
               tambah ruang kosong supaya
               grid kekal 2 x 2.
            */
...
function updateMomentPosition(
    ...
    if (indicator) {
        ...
        indicator.textContent =
            `${currentMomentPage + 1} / ${total}`;
    }
}


/* =========================================================
   MOMENT NEXT / PREVIOUS
========================================================= */
...
/*
   ID INI MESTI SAMA DENGAN index.html
*/
...
async function init() {
    ...
    /*
       Set muzik dahulu supaya source sudah
       tersedia walaupun Firebase lambat.
    */
